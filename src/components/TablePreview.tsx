...
export function TablePreview({ table }: TablePreviewProps) {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col h-full min-h-0 transition-colors duration-200">
            ...
            <div className="flex-1 min-h-0 overflow-auto bg-white dark:bg-slate-900 p-0 relative rounded-b-xl custom-scrollbar">
